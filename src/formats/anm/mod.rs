...
fn colorkey_to_meta(colorkey: u32) -> impl ToMeta {
    ast::Expr::LitInt { value: colorkey as i32, format: ast::IntFormat { unsigned: true, radix: ast::IntRadix::Hex } }
}
...
impl Version {
    fn from_game(game: Game) -> Self {
        ...
        match game {
            ...
            Th13 | Th14 | Th143 | Th15 | Th16 | Th165 | Th17 | Th18 | Th185 | Th19 | Th20 => Version::V8,
        }
    }
